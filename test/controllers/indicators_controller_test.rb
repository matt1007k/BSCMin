...
class IndicatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indicator" do
    assert_difference('Indicator.count') do
      post indicators_url, params: { indicator: { aclarar: @indicator.aclarar, indicador: @indicator.indicador, objective_id: @indicator.objective_id, variable: @indicator.variable } }
    end
  ...
  test "should update indicator" do
    patch indicator_url(@indicator), params: { indicator: { aclarar: @indicator.aclarar, indicador: @indicator.indicador, objective_id: @indicator.objective_id, variable: @indicator.variable } }
